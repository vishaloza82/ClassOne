...
namespace ClassOne.Models
{
    ...
    public partial class usp_GetPackageMappingProductListForCustomizationWithMarketPurchaseFlag_Result
    {
        ...
        public Nullable<int> PackageMappingProductId { get; set; }
        public Nullable<bool> AvailableForDelivery { get; set; }
        public Nullable<bool> SaleClubbed { get; set; }
        public Nullable<int> CategoryId { get; set; }
        public string CategoryName { get; set; }
        public Nullable<bool> PurchaseFromMarketFlag { get; set; }
    }
}
